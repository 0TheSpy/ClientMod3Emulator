...
#define __SPAIR16__(high, low)  (((int16)  (high) <<  8) | (ubool) (low))
...
#define __PAIR16__(high, low)   (((uint16) (high) <<  8) | (ubool) (low))
...
inline ubool  __ROL1__(ubool  value, int count) { return __ROL__((ubool)value, count); }
inline uint16 __ROL2__(uint16 value, int count) { return __ROL__((uint16)value, count); }
inline uint32 __ROL4__(uint32 value, int count) { return __ROL__((uint32)value, count); }
inline uint64 __ROL8__(uint64 value, int count) { return __ROL__((uint64)value, count); }
inline ubool  __ROR1__(ubool  value, int count) { return __ROL__((ubool)value, -count); }
...
template<class T, class U> bool __CFSUB__(T x, U y, bool cf) {
#if SUB_WITH_CARRY
    cf = !cf;
#endif
...
template<class T, class U> bool __OFSUB__(T x, U y, bool cf) {
#if SUB_WITH_CARRY
    cf = !cf;
#endif
...
inline ubool   abs8(bool     x) { return x >= 0 ? x : -x; }
...
#define abs8(x)   (bool)  ((bool)  (x) >= 0 ? (x) : -(x))
